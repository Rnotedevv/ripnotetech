...
import { getDashboardKpis, getProductsForDashboard, getSettings, listRecentActivities, listRecentOrders } from '@/lib/db';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard label="Total Order" value={stats.total_paid_orders} hint="Order sukses dibayar dari saldo" />
        ...
        <Card title="Pengaturan Menu Utama" description="Edit tampilan menu utama bot dan teks welcome dari dashboard.">
          <form action="/api/settings" method="POST" className="grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <textarea id="welcome_text" name="welcome_text" defaultValue={settings.welcome_text} className="mt-2 min-h-28" />
            </div>
            <div className="md:col-span-2">
              <label htmlFor="support_text">Support Text</label>
              <textarea id="support_text" name="support_text" defaultValue={settings.support_text} className="mt-2 min-h-24" />
            </div>
            <div>
